    ...
    <div className="image-view-container container">
      ...
      <div>
        <div className="content-section">
          <h2 className="main-heading">Welcome to Lettermaker</h2>
          <p className="content">
        ...
        <div className="content-section">
          <h2 className="main-heading">Explore Email Maker</h2>
          <p className="content">
        ...
        <div className="content-section">
          <h2 className="main-heading">Build Your Resume</h2>
          <p className="content">
        ...
        <div className="content-section">
          <h2 className="main-heading">Cover Letter Maker</h2>
          <p className="content">
        ...
        <div className="content-section">
          <h2 className="main-heading">More Tools Coming Soon!</h2>
          <p className="content">
